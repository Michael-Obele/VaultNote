    ...
    <aside class="inset-y fixed left-0 z-20 flex h-full flex-col border-r">
      ...
      <nav class="grid gap-1 p-2">
        <Tooltip>
          ...
          <TooltipContent side="right" sideOffset={5}>Notes</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger>
            <Button
          ...
          <TooltipContent side="right" sideOffset={5}>Clipboard</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger>
            <Button
          ...
          <TooltipContent side="right" sideOffset={5}>Passwords</TooltipContent>
        </Tooltip>
      </nav>
      ...
      <nav class="mt-auto grid gap-1 p-2">
        ...
        <Tooltip>
          ...
          <TooltipContent side="right" sideOffset={5}>Auth</TooltipContent>
        </Tooltip>
      </nav>
    </aside>
